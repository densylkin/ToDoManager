...
public class ToDoEditor : EditorWindow
{
    internal class Styles
    {
        ...
        public static GUIStyle activeTagStyle;
    ...
    {
        get { return AssetsRelativePath(Application.dataPath + "/ToDo/todo.asset"); }
    }
    ...
    private void OnEnable()
    {
        ...
        _data = ScriptableObjectUtils.LoadOrCreateAsset<TodoData>(DataPath);
        RefreshEntriesToShow();
    ...
    private void ScanFile(string filePath)
    {
        ...
        using (var parser = new ScriptsParser(filePath, Tags))
        {
    ...
    private void RefreshFiles()
    {
        ...
        csFiles = assetsDir.GetFiles("*.cs", SearchOption.AllDirectories);
    }
    ...
    public string AssetsRelativePath(string absolutePath)
    {
    ...
    {
        searchStr = GUILayout.TextField(searchStr, GUI.skin.FindStyle("ToolbarSeachTextField"), options);
